...
const ListBooks = () => {
    return (
        ...
        <div class="form-group row my-3 justify-content-between justify-content-md-start">
            <div>
            <div class="d-flex justify-content-center hidenElement"><small>Descendente</small></div>
            <button className="btn btn-primary ml-2"><FontAwesomeIcon icon={['fas', 'chevron-down']}/></button>
            </div>

            <div className="mx-1 mx-md-4">
                <div class="d-flex justify-content-center"><small>Ordenar</small></div>
            ...
            <div className="mr-2">
                <div class="d-flex justify-content-center"><small>20 - 300</small></div>
